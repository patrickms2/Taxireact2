...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'ba6ae731c134e7c63d8dd4f61b1f341b',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  project_uuid: '4927452b-6310-4463-bd5f-f306616e3b3a',
  flHost:
...
config.pexelsQuery = 'urban taxi service concept';
config.host =
