...
module.exports = class EstadisticasDBApi {
  ...
  static async update(id, data, options) {
    ...
    if (data.tipo_estadistica !== undefined)
      updatePayload.tipo_estadistica = data.tipo_estadistica;

    if (data.fecha !== undefined) updatePayload.fecha = data.fecha;

    updatePayload.updatedById = currentUser.id;

    await estadisticas.update(updatePayload, { transaction });

    if (data.usuario !== undefined) {
      await estadisticas.setUsuario(
        data.usuario,
    ...
    if (data.departamento !== undefined) {
      await estadisticas.setDepartamento(
        data.departamento,
    ...
    if (data.cooperativadetaxi !== undefined) {
      await estadisticas.setCooperativadetaxi(
