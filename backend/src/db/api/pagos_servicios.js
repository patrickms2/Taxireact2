...
module.exports = class Pagos_serviciosDBApi {
  ...
  static async update(id, data, options) {
    ...
    if (data.tipo_pago !== undefined) updatePayload.tipo_pago = data.tipo_pago;

    if (data.metodo_pago !== undefined)
      updatePayload.metodo_pago = data.metodo_pago;

    if (data.fecha_pago !== undefined)
      updatePayload.fecha_pago = data.fecha_pago;

    if (data.estado_pago !== undefined)
      updatePayload.estado_pago = data.estado_pago;

    updatePayload.updatedById = currentUser.id;

    await pagos_servicios.update(updatePayload, { transaction });

    if (data.servicio_taxi !== undefined) {
      await pagos_servicios.setServicio_taxi(
        data.servicio_taxi,
    ...
    if (data.cooperativadetaxi !== undefined) {
      await pagos_servicios.setCooperativadetaxi(
