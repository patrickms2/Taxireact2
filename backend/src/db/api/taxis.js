...
module.exports = class TaxisDBApi {
  ...
  static async update(id, data, options) {
    ...
    if (data.matricula !== undefined) updatePayload.matricula = data.matricula;

    if (data.marca !== undefined) updatePayload.marca = data.marca;

    if (data.modelo !== undefined) updatePayload.modelo = data.modelo;

    if (data.año !== undefined) updatePayload.año = data.año;
    ...
    await taxis.update(updatePayload, { transaction });

    if (data.taxista !== undefined) {
      await taxis.setTaxista(
        data.taxista,
    ...
    if (data.cooperativadetaxi !== undefined) {
      await taxis.setCooperativadetaxi(
