...
module.exports = class Servicios_taxiDBApi {
  ...
  static async update(id, data, options) {
    ...
    if (data.tipo_servicio !== undefined)
      updatePayload.tipo_servicio = data.tipo_servicio;

    if (data.fecha_solicitud !== undefined)
      updatePayload.fecha_solicitud = data.fecha_solicitud;

    if (data.fecha_realizacion !== undefined)
      updatePayload.fecha_realizacion = data.fecha_realizacion;

    if (data.estado_servicio !== undefined)
      updatePayload.estado_servicio = data.estado_servicio;

    if (data.ubicacion_origen !== undefined)
      updatePayload.ubicacion_origen = data.ubicacion_origen;

    if (data.ubicacion_destino !== undefined)
      updatePayload.ubicacion_destino = data.ubicacion_destino;

    updatePayload.updatedById = currentUser.id;

    await servicios_taxi.update(updatePayload, { transaction });

    if (data.taxi !== undefined) {
      await servicios_taxi.setTaxi(
        data.taxi,
    ...
    if (data.cooperativadetaxi !== undefined) {
      await servicios_taxi.setCooperativadetaxi(
