...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setCooperativadetaxi(data.data.cooperativadetaxi || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setCooperativadetaxi(data.cooperativadetaxi || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.cooperativadetaxi = await users.getCooperativadetaxi({
      transaction,
    });
