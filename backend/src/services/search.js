  ...
  static async search(searchQuery, currentUser, organizationId, globalAccess) {
    try {
      ...
      const tableColumns = {
        ...
        conductores: ['nombre', 'apellidos', 'dni', 'licencia_conducir'],

        departamentos: ['nombre_departamento'],

        documentos: ['nombre'],

        servicios_taxi: ['ubicacion_origen', 'ubicacion_destino'],

        taxis: ['matricula', 'marca', 'modelo', 'color'],

        taxistas: ['nombre', 'apellidos', 'dni', 'direccion', 'telefono'],

        usuarios: ['nombre', 'apellidos', 'email', 'password'],

        cooperativadetaxis: ['name'],
      };
      const columnsInt = {
        localizacion_taxis: ['latitud', 'longitud'],
