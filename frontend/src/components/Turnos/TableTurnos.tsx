...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/turnos/turnosSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTurnosCols';
...
const TableSampleTurnos = ({
  ...
  const {
    ...
    notify: turnosNotify,
    refetch,
  } = useAppSelector((state) => state.turnos);
  ...
  useEffect(() => {
    if (turnosNotify.showNotification) {
      notify(turnosNotify.typeNotification, turnosNotify.textNotification);
    }
  }, [turnosNotify.showNotification]);
...
export default TableSampleTurnos;
