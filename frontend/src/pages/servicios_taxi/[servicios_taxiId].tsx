...
const EditServicios_taxi = () => {
  ...
  const { servicios_taxiId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: servicios_taxiId }));
  }, [servicios_taxiId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: servicios_taxiId, data }));
...
EditServicios_taxi.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditServicios_taxi;
