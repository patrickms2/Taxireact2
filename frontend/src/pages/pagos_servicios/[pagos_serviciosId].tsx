...
const EditPagos_servicios = () => {
  ...
  const { pagos_serviciosId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: pagos_serviciosId }));
  }, [pagos_serviciosId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: pagos_serviciosId, data }));
...
EditPagos_servicios.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditPagos_servicios;
